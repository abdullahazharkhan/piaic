...
import DetailedNetwork from "@/components/DetailedNetwork";
      ...
      <Flex p={{ base: 8, sm: 14 }} minH="83vh" justify={"center"}>
        <Stack direction="column" spacing={6} alignItems="center" pt="120px">
          ...
          <Text maxW="550px" fontSize="xl" textAlign="center" color="gray.500">
            A ONE AND A QUARTER YEAR DEV PROGRAM DESIGNED FOR ABSOLUTE
            BEGINNERS. GETTING PAKISTAN READY FOR THE NEW ERA OF COMPUTING
            ENABLED BY THE RISE OF AUTOMATION.
          </Text>
        </Stack>
      </Flex>
      <Box>
