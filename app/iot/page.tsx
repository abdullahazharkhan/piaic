...
import DetailedIot from "@/components/DetailedIot";
      ...
      <Flex p={{ base: 8, sm: 14 }} minH="83vh" justify={"center"}>
        <Stack direction="column" spacing={6} alignItems="center" pt="120px">
          ...
          <Text maxW="550px" fontSize="xl" textAlign="center" color="gray.500">
            A FIFTEEN MONTHS IOT AND AI PROGRAM FOR ABSOLUTE BEGINNERS GETTING
            PAKISTAN READY FOR THE NEW ERA OF INTERNET OF THINGS AND AI.
          </Text>
        </Stack>
      </Flex>
      <Box>
